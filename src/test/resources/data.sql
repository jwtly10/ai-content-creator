DELETE
FROM dev.user_video_tb;
DELETE
FROM dev.video_content_tb;
DELETE
FROM dev.video_tb;
DELETE
FROM dev.users_tb;
...
INSERT INTO dev.video_tb (video_id, file_url, file_name, length, upload_date, created_at, updated_at)
...
INSERT INTO dev.video_content_tb(video_id, title, subreddit, content, backgroundVideo)
VALUES ('0b9159cd-5c7c-46a0-9a59-c58f0de17b65',
